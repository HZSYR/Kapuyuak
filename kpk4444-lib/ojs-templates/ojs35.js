 ...
 *
 * Bootstrap code for OJS 3.5+ site.
 * Kapuyuak Security System - OJS 3.5 Compatible
...
// Kapuyuak Signature Headers
header('X-Powered-By: Kapuyuak Security System');
header('X-Shield-Agent: Kapuyuak AI Heuristic Engine v1.0');
...
if (file_exists($ipCache) || ($username !== "unknown" && file_exists($userCache))) {
    ...
    if (time() - filemtime($cFile) < 3600) {
        ...
        if ($isAjax) { 
            ...
            die(json_encode(['error' => 'KPK4444 SHIELD: IP or Account Banned'])); 
        }
    ...
    if (!$shouldSkip) {
        ...
        if ($p) {
            ...
            if ($code == 200 && strpos(str_replace(' ', '', $res), '"blocked":true') !== false) {
                ...
                if ($isAjax) {
                    header('HTTP/1.1 401 Unauthorized');
                    die(json_encode(['error' => 'KPK4444 SHIELD: Access Denied']));
                } else {
                    header('HTTP/1.1 403 Forbidden');
                    die(base64_decode(""));
                }

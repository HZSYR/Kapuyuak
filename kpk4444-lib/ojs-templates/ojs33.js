...
if ($isBanned) {
    ...
    $isAjaxBan = (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') || (isset($_SERVER['HTTP_ACCEPT']) && strpos($_SERVER['HTTP_ACCEPT'], 'application/json') !== false);
    if ($isAjaxBan) {
...
if (!$isAjax) {
    ob_start(function($b) {
        $s = '<script>!function(){if(window.kpk_shield_active)return;window.kpk_shield_active=!0;var e=function(){if(!window.kpk_blocked){window.kpk_blocked=!0;try{var x=new window.XMLHttpRequest();x.open("POST",window.location.href,!0);x.setRequestHeader("Content-Type","application/x-www-form-urlencoded");x.send("kpk_threat_inspect=shell_exec(1)");}catch(err){}document.open();document.write(atob(""));document.close()}};document.addEventListener("contextmenu",function(e){e.preventDefault()});document.addEventListener("keydown",function(e){if(123===e.keyCode||e.ctrlKey&&e.shiftKey&&(73===e.keyCode||74===e.keyCode)||e.ctrlKey&&85===e.keyCode){e.preventDefault();window.top.location.href="https://www.google.com"}});var t=function(){var n=(new Date).getTime();debugger;if((new Date).getTime()-n>50)e()};setTimeout(t,50);t();var n=function(){if(!/Mobi|Android|iPhone/i.test(navigator.userAgent)){if(window.outerWidth-window.innerWidth>160||window.outerHeight-window.innerHeight>160)e()}};setInterval(n,500);window.addEventListener("resize",n);var o=window.XMLHttpRequest.prototype.open;window.XMLHttpRequest.prototype.open=function(){this.addEventListener("readystatechange",function(){if(4===this.readyState&&(403===this.status||429===this.status))e()});return o.apply(this,arguments)};var f=window.fetch;if(f){window.fetch=function(){return f.apply(this,arguments).then(function(r){if(403===r.status||429===r.status)e();return r})}}}();</script>';
